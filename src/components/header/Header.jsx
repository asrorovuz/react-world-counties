...
export const Header = ( {changeTheme, theme} ) => {
    return (
        <div className={classNames("header", theme ? "theme-block" : "")}>
            <div className={classNames("container", "dp", )}>
                <h1>Where in the world?</h1>
                <div className={classNames("theme", "dp")} onClick={changeTheme}>
                    <div className={classNames("theme-icon", "dp")}>
